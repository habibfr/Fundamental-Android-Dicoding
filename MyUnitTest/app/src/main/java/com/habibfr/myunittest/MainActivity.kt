...
import com.habibfr.myunittest.databinding.ActivityMainBinding
    ...
    override fun onClick(v: View?) {
        ...
        when {
            ...
            TextUtils.isEmpty(height) -> {
                ...
                when (v?.id) {
                    R.id.btn_save -> {
                        mainViewModel.save(valueWidth, valueHeight, valueLength)
                        visible()
                    }
                    ...
                    R.id.btn_calculate_surface_area -> {
                        activityMainBinding.tvResult.text = mainViewModel.getSurfaceAre().toString()
                        gone()
                    }
